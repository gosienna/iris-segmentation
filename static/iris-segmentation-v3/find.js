function find(){
  //extract the diameter from the marker picture first
  var diameter=extract_diameter();
//  console.log(diameter)
  compute('iris-R','final-R','right',diameter);
  compute('iris-L','final-L','left',diameter);

  function compute(iris,final,source,diameter){
